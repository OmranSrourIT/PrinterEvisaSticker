...
namespace PrinterEvisaSticker.WebApi
{
    public class PDFTemplateFields
    {
        ...
        public string P_DepaturePeriod_DA;
        public string P_NoOfEntries; 
        ...
        public string P_IssuingAuthority_ARA;
        public string P_FullName_ARA;
        public string P_Nationality_ARA;
        public string P_Requester_ARA;
